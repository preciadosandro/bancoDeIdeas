...
Insert into TB_LISTAVALORDETALLE (ID,ID_T_LISTAVALORES,VALOR,ESTADO,CREADOPOR,MODIFICADOPOR,MODIFICADOEN) values ('46','8','Registrada','1','raphael.lara',null,null);
